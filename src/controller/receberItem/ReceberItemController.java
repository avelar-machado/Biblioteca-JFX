 ...
 */
package controller.receberItem;
...
public class ReceberItemController implements Initializable {
   ...
   @FXML
    ...
    @FXML
    private void btnReceber() throws ClassNotFoundException, ParseException {
        ...
        dialog.setTitle("Devolução");
        
        Label label = new Label("Devolução Realizada com Sucesso.");
