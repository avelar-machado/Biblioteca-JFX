 ...
 */
package controller.itensDisponiveis;
 ...
 * @author hp
 */
public class ItensDisponiveisController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            Logger.getLogger(ItensDisponiveisController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
