...
public class RegistarRevistaController implements Initializable {
    ...
    @FXML
    private void btnRegistarRevista() throws ClassNotFoundException, ParseException, SQLException {
        ...
        RevistaModel rv = new RevistaModel();
        it.registarItem(item);

        ArrayList<Item> au1 = it.pesquisarItem();
        Item au2 = au1.get(au1.size() - 1);

        Revista revista = new Revista(Integer.parseInt(issnRevista.getText()), editoraRevista.getText(), Integer.parseInt(edicaoRevista.getText()), Integer.parseInt(numeroRevista.getText()));
        revista.setId(au2.getId());
        item.setId(au2.getId());
        rv.registarRevista(revista);
        
        tituloItem.setText("");
        editoraRevista.setText("");
        issnRevista.setText("");
        edicaoRevista.setText("");
        ...
        dialog.setTitle("Revista");
        
        Label label = new Label("Revista gravada com Sucesso.");
